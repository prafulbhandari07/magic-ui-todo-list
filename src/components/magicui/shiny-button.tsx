...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className="relative block h-full w-full text-sm uppercase tracking-wide text-[rgba(172,70,255,0.65)] dark:font-light dark:text-[rgba(168,28,28,0.9)]"
        style={{
          maskImage:
      ...
      <span
        style={{
          mask: "linear-gradient(rgb(236,236,236)) content-box,linear-gradient(rgb(0,0,0), rgb(0,0,0))",
